...
public class PsychologyAndMentalHealthFragment extends Fragment {
    ...
    public PsychologyAndMentalHealthFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        databaseReference = firebaseDatabase.getReference("Health_Posts");

        recyclerView = view.findViewById(R.id.r_v_health);
