...
public class NewsAndPoliticsFragment extends Fragment {
    ...
    public NewsAndPoliticsFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_news_and_politics, container, false);


        firebaseDatabase = FirebaseDatabase.getInstance();
        databaseReference = firebaseDatabase.getReference("News_Posts");

        recyclerView = view.findViewById(R.id.r_v_news);
